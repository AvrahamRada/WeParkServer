...
public interface ActionDao extends MongoRepository<ActionEntity,String>{ //extends PagingAndSortingRepository<ActionEntity, String> {
...
//	public List<ActionEntity> findOneByInvokedByAndTopByOrderByCreatedTimestampDesc(@Param("invokedBy") String invokedBy, Pageable pageable);
	...
	// SELECT * FROM ELEMENTS WHERE NAME LIKE ?
	public List<ActionEntity> findOneByInvokedBy(
			@Param("invokedBy") String invokedBy, 
								Pageable pageable);

	public List<ActionEntity> findOneByInvokedByAndTypeLike(
			@Param("invokedBy") String invokedBy,
